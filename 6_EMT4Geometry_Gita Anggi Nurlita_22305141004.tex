...
\begin{eulerttcomment}
  ...
  getHesseForm (g,x,y,A): bentuk Hesse garis g dinyatakan dalam x dan y dengan 
  titik A pada sisi positif (kanan/atas) garis
  quad(A,B): kuadrat jarak AB
  spread(a,b,c): Spread segitiga dengan panjang sisi-sisi a,b,c, yakni
  sin(alpha)\textasciicircum{}2 dengan alpha sudut yang menghadap sisi a.
  crosslaw(a,b,c,sa): persamaan 3 quads dan 1 spread pada segitiga dengan panjang 
  sisi a, b, c.
  triplespread(sa,sb,sc): persamaan 3 spread sa,sb,sc yang membentuk suatu segitiga
  doublespread(sa): Spread sudut rangkap Spread 2*phi, dengan sa=sin(phi)\textasciicircum{}2 
  spread a.\\
\end{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-004.png}
...
\end{eulercomment}
\eulersubheading{Jawaban Latihan}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-005.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-006.png}
\begin{eulerprompt}
...
>color(5); plotLine(h):
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-008.png}
\begin{eulercomment}
...
\end{eulerformula}
\eulerimg{1.8}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-012-large.png}
\begin{eulerprompt}
...
\end{eulerformula}
\eulerimg{2.2}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-014-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0.6}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-020-large.png}
\begin{eulerprompt}
...
>P &= lineIntersection(angleBisector(A,C,B),angleBisector(C,B,A)); $P ...
 // titik potong 2 garis bagi sudut
\end{eulerprompt}
\begin{eulerformula}
\[
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-024.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-026.png}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-036.png}
\begin{eulerprompt}
>remvalue x,y,a,b,c
...
\end{eulerformula}
\begin{eulercomment}
Tentu saja, setiap segitiga siku-siku adalah kasus yang sudah
diketahui.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-040.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Sekarang mari kita cari himpunan semua titik dimana b+c=d untuk suatu
...
\]
\end{eulerformula}
\eulerimg{2.6}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-044-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-045.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
dimana (xm,ym) adalah pusatnya, serta u dan v adalah setengah
sumbunya.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Kita dapatkan nilai minimum, yang dimiliki oleh segitiga dengan salah
...
\]
\end{eulerformula}
\eulerimg{0.9}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-052-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-053.png}
\begin{eulercomment}
Plot segmennya.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-054.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-056.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
untuk jari-jari. Kita bisa cek, apakah hal tersebut memang benar
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-059.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1.8}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-063-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-066.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Tambahkan itu ke plot kita.
\end{eulercomment}
\begin{eulerprompt}
>plotPoint(H(),"H"); plotLine(el(),"Garis Euler"):
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-069.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-071.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Fungsinya juga mencakup fungsi sudut.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Mari kita hitung juga persamaan jari-jari lingkaran yang tertulis.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-076.png}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-078.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-080.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0.6}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-083-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-086-large.png}
\begin{eulercomment}
...
Intinya adalah perhitungan rasional simbolik seringkali memberikan hasil yang sederhana. Sebaliknya, 
trigonometri klasik menghasilkan
...
>insimg(30);
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-087.png}
\begin{eulercomment}
Tentu saja,
...
\]
\end{eulerformula}
\eulerimg{2}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-095-large.png}
\begin{eulercomment}
...
\begin{eulerformula}
\[
\left[ \left[ \frac{168\,{\it bb}\,x+36\,{\it bb}^2+\left(-72\,  {\it aa}-84\right)\,{\it bb}+36\,{\it aa}^2-84\,{\it aa}+49}{36} ,   \frac{168\,{\it bb}\,x+36\,{\it bb}^2+\left(-72\,{\it aa}-84\right)  \,{\it bb}+36\,{\it aa}^2-84\,
{\it aa}+49}{36} , \frac{15\,2^{\frac{  5}{2}}\,{\it bb}\,x+18\,{\it bb}^2+\left(-36\,{\it aa}-15\,2^{\frac{  3}{2}}\right)\,{\it bb}+18\,{\it aa}^2-15\,2^{\frac{3}{2}}\,{\it aa}  +25}{18} \right] =0 \right] 
\]
\end{eulerformula}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Sudut ini dinyatakan dalam derajat.
\end{eulercomment}
\begin{eulerprompt}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-100.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0.8}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-103-large.png}
\eulerimg{0.8}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-104-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1.8}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-111-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1.8}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-120-large.png}\\
...
\end{eulerformula}
\begin{eulercomment}
Karena penyebaran sudut negatifnya sama, maka aturan triple spread
juga berlaku, jika
...
\]
\end{eulerformula}
\eulerimg{0}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-128-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-130.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-132-large.png}
\eulerimg{1.8}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-133-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-135.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-140.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-144.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-145.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-146.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-147.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-148.png}
\begin{eulercomment}
\end{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-149.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-150.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-151.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-152.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-153.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-154.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-155.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-156.png}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-157.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-161.png}
...
\begin{eulerprompt}
>load povray;
>defaultpovray="D:\(\backslash\)SOFTWARE APKOM\(\backslash\)povray\(\backslash\)bin\(\backslash\)pvengine.exe"
\end{eulerprompt}
\begin{euleroutput}
  D:\(\backslash\)SOFTWARE APKOM\(\backslash\)povray\(\backslash\)bin\(\backslash\)pvengine.exe
\end{euleroutput}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-162.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-163.png}\\
...
\end{eulercomment}
\begin{eulerprompt}
>br=svector(FMIPA,Solo); degprint(br[1]), br[2]*rearth(7°)->km ...
 // perkiraan jarak FMIPA-Solo
\end{eulerprompt}
\begin{euleroutput}
  65°20'26.60''
  53.8945384608
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-164.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-165.png}
\\
...
misalnya A, B, C, D.\\
- Tentukan apakah segi-4 tersebut merupakan segi-4 garis singgung (sisinya-sisintya merupakan garis singgung lingkaran yang sama yakni
...
>plotPoint(O,"O"):
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-166.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-167.png}
\begin{eulerprompt}
>plotSegment(P1,P4,"a"); plotSegment(P4,P2,"b");  ...
>plotSegment(P2,P3,"c"); plotSegment(P3,P1,"d"):
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-168.png}
\begin{eulercomment}
\end{eulercomment}
\eulersubheading{}
\begin{eulercomment}
...
Misalkan\\
Diketahui persamaan parabolanya y= ax\textasciicircum{}2+bx+c dengan koordinat
...
y=x\textasciicircum{}2+2x+1.
\end{eulercomment}
\begin{eulerprompt}
>plotPoint([-1,0],"A"); plotPoint([1,4],"B"); plotPoint([-2,1],"C"); ...
>plot2d("x^2+2*x+1",-7,5,-1,5,>add):
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-169.png}
\begin{eulercomment}
\end{eulercomment}
\eulersubheading{}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-170.png}
\begin{eulerprompt}
>plotCircle(circleWithCenter([0,0],2)):
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-171.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-172.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-173.png}
\begin{eulercomment}
...
a=a1=a2=5\\
Dari situ diperoleh b\textasciicircum{}2=a\textasciicircum{}2-c\textasciicircum{}2=5\textasciicircum{}2-4\textasciicircum{}2=9 sehingga b=3
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-174.png}
\begin{eulercomment}
...
\begin{eulerformula}
\[
y = \pm \sqrt{9-\frac{9x^2}{25}}
\]
\end{eulerformula}
\begin{eulerprompt}
>plot2d("sqrt(9-((9*x^2)/25))",>add); plot2d("-sqrt(9-((9*x^2)/25))",>add):
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-179.png}
\begin{eulercomment}
\end{eulercomment}
\eulersubheading{}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-180.png}
\begin{eulercomment}
Dimisalkan b=3\\
maka a\textasciicircum{}2=c\textasciicircum{}2-b\textasciicircum{}2=5\textasciicircum{}2-3\textasciicircum{}2=16 sehingga diperoleh a=4
...
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-181.png}
\begin{eulercomment}
...
\begin{eulerformula}
\[
y = \pm \sqrt{\frac{9x^2}{16}-9}
\]
\end{eulerformula}
\begin{eulerprompt}
>plot2d("3*x/4",style="--",>add); plot2d("-3*x/4",style="--",>add);
>plot2d("sqrt(((9*x^2)/16)-9)",>add); plot2d("-sqrt(((9*x^2)/16)-9)",>add):
\end{eulerprompt}
\eulerimg{27}{images/Gita Anggi Nurlita_22305141004_EMT4Geometry-188.png}
\end{eulernotebook}
