# Gita Anggi Nurlita_22305141004_EMT4Geometry
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-001.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-001.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-003.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-003.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-004.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-004.png)
...
\>E=lineCircleIntersections(lineThrough(B,C),circleWithCenter(P,r));

\>F=lineCircleIntersections(lineThrough(A,C),circleWithCenter(P,r));

\>G=lineCircleIntersections(lineThrough(A,B),circleWithCenter(P,r));

\>plotPoint(E,value=1); plotPoint(F,value=1); plotPoint(G,value=1):


![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-005.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-005.png)

Jadi, ketiga titik singgung lingkaran dalam dengan sisi-sisi segitiga
ABC, yaitu :


Titik E (0.63,1.3) = titik singgung lingkaran dalam dengan sisi BC


Titik F (0.3,0.63) = titik singgung lingkaran dalam dengan sisi AC


Titik G (0.5,0.5) = titik singgung lingkaran dalam dengan sisi AB


---

2. Akan digambar segitiga dengan titik-titik sudut ketiga titik
singgung tersebut. Merupakan segitiga apakah itu?


\>e=lineThrough(E,F); f=lineThrough(F,G); g=lineThrough(E,G);

\>aspect(1); plotSegment(E,F); plotSegment(F,G); plotSegment(E,G):


![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-006.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-006.png)

\>norm(E-F), norm(F-G), norm(E-G) // menghitung panjang setiap sisi segitiga EFG
...
Terdapat dua sisi segitiga yang sama panjang. Jadi, segitiga yang
terbentuk merupakan segitiga sama kaki.
...
Jadi, luas segitiga tersebut adalah 0.324341649025
...
\>h=angleBisector(A,B,C); // garis bagi <ABC

\>color(5); plotLine(h):


![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-007.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-007.png)

Dari gambar plot diatas terlihat bahwa garis bagi sudut yang ke tiga
juga melalui titik pusat lingkaran dalam.
...
\>color(1); plotSegment(E,P,"r"): 


![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-008.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-008.png)

Dari gambar plot diatas terlihat jari-jari lingkaran dalam (r) dari
titik pusat P ke titik E.
...
\>LLL = pi\*norm(O-A)\*norm(O-A)


    4.36332312999

\>LLD = pi\*norm(E-P)\*norm(E-P)


    0.81601903655

\>LS = norm(A-D)\*norm(B-C)/2 


    1.5

\>a=norm(A-B), b=norm(B-C), c=norm(A-C)
...
\>LS1 = (sqrt(LLD/pi)\*(a+b+c))/2


    1.5

\>LS2 = (a\*b\*c)/(4\*sqrt(LLL/pi))


    1.5

Jadi, luas lingkaran luar = 4.36332312999 dan luas lingkaran dalam
segitiga ABC = 0.81601903655


Hubungan antara luas kedua lingkaran tersebut dengan luas segitiga
ABC, yaitu :


- Lingkaran dalam dan segitiga :


$$LS = \frac{\sqrt{\frac{LLD}{\pi}}(a+b+c)}{2}$$* 
Lingkaran luar dan segitiga :
*   LS = \frac{abc}{4 \sqrt{\frac{LLL}{\pi}}}


$$LS = \frac{abc}{4 \sqrt{\frac{LLL}{\pi}}}$$keterangan:


LS = luas segitiga


LLD = luas lingkaran dalam


LLL = luas lingkaran luar


# Contoh 2: Geometri Simbolik

Kita dapat menghitung geometri secara eksak dan simbolik menggunakan
Maxima.
...
$$\left[ y=\frac{x}{2}+1 \right] $$![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-012.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-012.png)

\>$getLineEquation(lineThrough([x1,y1],[x2,y2]),x,y), $solve(%,y) // persamaan garis melalui(x1, y1) dan (x2, y2)


$$\left[ y=\frac{-\left({\it x_1}-x\right)\,{\it y_2}-\left(x-  {\it x_2}\right)\,{\it y_1}}{{\it x_2}-{\it x_1}} \right] $$![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-014.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-014.png)
...
$$1.178511301977579$$![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-020.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-020.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-024.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-024.png)

Hal yang sama juga terjadi di Maxima
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-026.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-026.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-027.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-027.png)
...
Persamaan perpotongan cukup rumit. Tapi kita bisa menyederhanakannya,
jika kita menyelesaikannya untuk y.
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-036.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-036.png)
...
$${\it Luas}=\frac{3\,\sqrt{39}}{4}$$Tentu saja, setiap segitiga siku-siku adalah kasus yang sudah
diketahui.
...
\>aspect (1.5);  ...  
\>   plot2d(&H(3,4,x),1,7): // Kurva luas segitiga sengan panjang sisi 3, 4, x (1<= x <=7)


![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-040.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-040.png)
...
$$\left[ c=-\sqrt{b^2+a^2} , c=\sqrt{b^2+a^2} , c=0 \right] $$Sekarang mari kita cari himpunan semua titik dimana b+c=d untuk suatu
konstanta d. Diketahui bahwa ini merupakan ellips.
...
$$\frac{\sqrt{-\left(d-c\right)^4+2\,c^2\,\left(d-c\right)^2+2\,a^2\,  \left(d-c\right)^2-c^4+2\,a^2\,c^2-a^4}}{2\,a}$$![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-044.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-044.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-045.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-045.png)

Kita dapat memeriksa persamaan umum untuk elips ini, yaitu.


$$\frac{(x-x_m)^2}{u^2}+\frac{(y-y_m)}{v^2}=1,$$dimana (xm,ym) adalah pusatnya, serta u dan v adalah setengah
sumbunya.
...
tersebut sama sisi. Kita ingin menyimpulkan hal ini secara analitis.


\>eqns &= [diff(H(a,b,d-(a+b))^2,a)=0,diff(H(a,b,d-(a+b))^2,b)=0]; $eqns


$$\left[ \frac{d\,\left(d-2\,a\right)\,\left(d-2\,b\right)}{8}-\frac{  \left(-d+2\,b+2\,a\right)\,d\,\left(d-2\,b\right)}{8}=0 , \frac{d\,  \left(d-2\,a\right)\,\left(d-2\,b\right)}{8}-\frac{\left(-d+2\,b+2\,  a\right)\,d\,\left(d-2\,a\right)}{8}=0 \right] $$Kita dapatkan nilai minimum, yang dimiliki oleh segitiga dengan salah
satu sisinya 0, dan solusinya a=b=c=d/3.
...
$$\left[ a , 0 \right] $$![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-052.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-052.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-053.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-053.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-054.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-054.png)

Compute the middle perpendicular in Maxima.


Hitung garis bagi tegak lurus di Maxima.
...
Kita dapatkan rumus untuk jari-jari lingkaran luar.
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-056.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-056.png)

Dengan menggunakan geometri, kita memperoleh rumus sederhana


$$\frac{a}{\sin(\alpha)}=2r$$untuk jari-jari. Kita bisa cek, apakah hal tersebut memang benar
terjadi pada Maxima. Maxima akan nemfaktorkan ini hanya jika kita
mengkuadratkannya.
...
Pertama, kita mendefinisikan sudut-sudut segitiga di Euler. Kita
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-059.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-059.png)

Berikut luas segitiga menggunakan rumus determinan. Tentu saja, kita
harus mengambil nilai mutlak dari hasil ini.
...
$$\frac{7}{\sqrt{10}}$$![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-063.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-063.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-066.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-066.png)
...
$$-\frac{19\,y}{14}-\frac{x}{14}=-\frac{1}{2}$$Tambahkan itu ke plot kita.


\>plotPoint(H(),"H"); plotLine(el(),"Garis Euler"):


![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-069.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-069.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-071.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-071.png)

Teori ini memberitahu kita MH=2*MO. Kita perlu menyederhanakan dengan
...
$$2$$Fungsinya juga mencakup fungsi sudut.
...
$$\left[ \frac{\left(2^{\frac{3}{2}}+1\right)\,\sqrt{5}\,\sqrt{13}-15  \,\sqrt{2}+3}{14} , \frac{\left(\sqrt{2}-3\right)\,\sqrt{5}\,\sqrt{  13}+5\,2^{\frac{3}{2}}+5}{14} \right] $$Mari kita hitung juga persamaan jari-jari lingkaran yang tertulis.
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-076.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-076.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-078.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-078.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-080.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-080.png)
...
$$2.135605779339061$$![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-083.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-083.png)
...
$$2.135605779339061$$![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-086.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-086.png)
...
Hal ini terinspirasi oleh pembicaraan N.J.Wildberger. Dalam bukunya
...
diajak untuk mengecek hasilnya tanpa komputer.
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-087.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-087.png)
...
Trigonometri rasional berusaha menghindari hal ini.


Konsep trigonometri rasional yang pertama adalah kuadran, yang
...
Gagasan trigonometri rasional yang kedua adalah penyebaran. Penyebaran
mengukur pembukaan antar garis. Nilainya 0 jika garisnya sejajar, dan
1 jika garisnya persegi panjang. Ini adalah kuadrat sinus sudut antara
dua garis.
...
sebaran, dan mencetaknya sebagai pecahan.
...
Hukum kosinus trigonometri klasik diterjemahkan menjadi "cross law"
berikut.
...
$$\left[ x=\frac{9}{25} \right] $$![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-095.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-095.png)

Kami sudah tahu ini. Pengertian penyebaran merupakan kasus khusus dari
hukum silang.
...
$$\frac{6}{7}$$Sudut ini dinyatakan dalam derajat.
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-100.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-100.png)
...
$$17$$![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-103.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-103.png)

![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-104.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-104.png)
...
$$\left[ x=\frac{49}{50} \right] $$![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-111.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-111.png)
...
$$\frac{\left(-c+b+a\right)\,\left(c-b+a\right)\,\left(c+b-a\right)\,  \left(c+b+a\right)}{16}$$![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-120.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-120.png)
...
$$\alpha, \pi-\alpha$$sama, aturan triple spread juga berlaku, jika


$$\alpha+\beta=\gamma$$Karena penyebaran sudut negatifnya sama, maka aturan triple spread
juga berlaku, jika
...
$$\left[ x=1-y \right] $$![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-128.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-128.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-130.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-130.png)

Mari kita hitung panjang garis bagi sudut di A. Tapi kita ingin
menyelesaikannya untuk persamaan umum a,b,c.
...
$$\frac{-\sqrt{b}\,\sqrt{b+a}+b+a}{2\,b+2\,a}$$![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-132.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-132.png)

![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-133.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-133.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-135.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-135.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-140.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-140.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-144.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-144.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-145.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-145.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-146.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-146.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-147.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-147.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-148.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-148.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-149.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-149.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-150.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-150.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-151.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-151.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-152.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-152.png)
...
Java yang memiliki instruksi "contour lines" ...


Semua hal di atas ditemukan oleh seorang hakim Perancis bernama Pierre
de Fermat; dia menulis surat kepada para penggemar lainnya seperti
...
menemukannya! Bagaimanapun tradisinya adalah memperhatikan hal ini
F...
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-153.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-153.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-154.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-154.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-155.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-155.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-156.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-156.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-157.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-157.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-161.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-161.png)
...
Kami mengatur scene dengan tepat.
...
Dan bentuk kerucutnya transparan.
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-162.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-162.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-163.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-163.png)

# Contoh 8: Geometri Bumi

Di notebook ini, kami ingin melakukan beberapa perhitungan sferis.
...
Heading mempunyai fungsi dengan memperhatikan bentuk bumi yang elips.
...
Posnya sama dengan yang dihitung di Google Earth.
...
Sekarang kita tambah 10 kali sepersepuluh jaraknya, dengan menggunakan
tujuan Monas, kita sampai di Tugu.
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-164.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-164.png)
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-165.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-165.png)
...
Akan digambar segi-4 beraturan


Diketahui titik pusat O, n=4, r=5.


- Besar sudut pusat yang menghadap masing-masing sisi segi-4 adalah
(360/4=90).


- Titik-titik sudut segi-4 merupakan perpotongan lingkaran luar segi-4
dan garis-garis yang melalui pusat dan saling membentuk sudut sebesar
kelipatan (360/4=90).


\>c=circleWithCenter([0,0],5);

\>setPlotRange(6); plotCircle(c);
...
![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-166.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-166.png)

\>A &:= [5,0]; B &:= [-5,0]; C &:= [0,5]; D &:= [0,-5]; ...  
\>   l=lineThrough(A,B); plotLine(l); m=lineThrough(C,D); plotLine(m);

\>{P1,P2,f}=lineCircleIntersections(l,c); ...  
\>   {P3,P4,f}=lineCircleIntersections(m,c);

\>plotPoint(P1); plotPoint(P2); plotPoint(P3); plotPoint(P4):


![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-167.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-167.png)

\>plotSegment(P1,P4,"a"); plotSegment(P4,P2,"b");  ...  
\>   plotSegment(P2,P3,"c"); plotSegment(P3,P1,"d"):


![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-168.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-168.png)
...
Diketahui persamaan parabolanya y= ax^2+bx+c dengan koordinat
titik-titik (-1,0), (1,4), dan (-2,1).
...
Diperoleh a=1,b=2,dan c=1 sehingga persamaan parabola adalah
y=x^2+2x+1.


\>plotPoint([-1,0],"A"); plotPoint([1,4],"B"); plotPoint([-2,1],"C"); ...  
\>   plot2d("x^2+2\*x+1",-7,5,-1,5,\>add):


![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-169.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-169.png)
...
Misalkan diketahui suatu segi-4 dengan keempat titik sudutnya, yaitu A
(-2,2), B (2,2), C (2,-2), dan D (-2,-2).


\>A=[-2,2]; B=[2,2]; C=[2,-2]; D=[-2,-2];

\>setPlotRange(5); plotPoint(A,"A"); plotPoint(B,"B");  ...  
\>   plotPoint(C,"C"); plotPoint(D,"D"); plotPoint([0,0],"O");

\>plotSegment(A,B); plotSegment(B,C); plotSegment(C,D); plotSegment(A,D):


![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-170.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-170.png)

\>plotCircle(circleWithCenter([0,0],2)):


![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-171.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-171.png)

Terlihat bahwa sisinya-sisintya merupakan garis singgung lingkaran
yang sama yakni lingkaran dalam segi-4 tersebut.


\>k=angleBisector(B,A,D); l=angleBisector(A,B,C); m=angleBisector(B,C,D); ...  
\>   n=angleBisector(A,D,C); 

\>p=lineIntersection(k,l), q=lineIntersection(m,n)


    [0,  0]
    [0,  0]

\>color(5); plotLine(k); plotLine(l);  ...  
\>   plotLine(m); plotLine(n); color(1):


![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-172.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-172.png)

Terlihat bahwa keempat garis bagi sudutnya bertemu di satu titik,
yaitu titik O(0,0).


\>norm(A-D)\*norm(B-C), norm(A-B)\*norm(C-D)


    16
    16

Terlihat bahwa hasil kali panjang sisi-sisi yang berhadapan sama,
yaitu 16.


Jadi, segi-4 tersebut merupakan segi-4 garis singgung.
...
Misalkan titik P (-4,0) dan Q (4,0)
...
\>setPlotRange(5); plotPoint(P,"P"); plotPoint(Q,"Q"):


![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-173.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-173.png)

Karena fokus P dan Q adalah tempat kedudukan titik-titik yang jumlah
jarak ke P dan ke Q selalu sama (a1+a2=konstan) maka


dimisalkan jumlah jarak ke P dan ke Q adalah 10 sehingga didapat
a=a1=a2=5


Dari situ diperoleh b^2=a^2-c^2=5^2-4^2=9 sehingga b=3


\>R=[-5,0]; S=[5,0]; plotPoint(R,"R"); plotPoint(S,"S"); ...  
\>   T=[0,3]; U=[0,-3]; plotPoint(T,"T"); plotPoint(U,"U"):


![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-174.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-174.png)

Dari a=5 dan b=3 diatas, dapat kita peroleh rumus ellips, yaitu


$$\frac{x^2}{a^2}+\frac{y^2}{b^2}=1$$$$\frac{x^2}{5^2}+\frac{y^2}{3^2}=1$$$$\frac{x^2}{25}+\frac{y^2}{9}=1$$$$y = \pm \sqrt{9-\frac{9x^2}{25}}$$\>plot2d("sqrt(9-((9\*x^2)/25))",\>add); plot2d("-sqrt(9-((9\*x^2)/25))",\>add):


![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-179.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-179.png)
...
Misalkan titik P (-5,0) dan Q (5,0)
...
\>setPlotRange(10); plotPoint(P,"P"); plotPoint(Q,"Q"):


![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-180.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-180.png)

Dimisalkan b=3


maka a^2=c^2-b^2=5^2-3^2=16 sehingga diperoleh a=4


\>R=[0,3]; S=[0,-3]; plotPoint(R,"R"); plotPoint(S,"S"); ...  
\>   T=[4,0]; U=[-4,0]; plotPoint(T,"T"); plotPoint(U,"U"):


![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-181.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-181.png)

Dari a=4 dan b=3 diatas, dapat kita peroleh rumus asimptot, yaitu


$$y=\pm \frac{bx}{a}$$$$y=\pm \frac{3x}{4}$$

dan rumus hiperbola, yaitu


$$\frac{x^2}{a^2}-\frac{y^2}{b^2}=1$$$$\frac{x^2}{4^2}+\frac{y^2}{3^2}=1$$$$\frac{x^2}{16}+\frac{y^2}{9}=1$$$$y = \pm \sqrt{\frac{9x^2}{16}-9}$$\>plot2d("3\*x/4",style="--",\>add); plot2d("-3\*x/4",style="--",\>add);

\>plot2d("sqrt(((9\*x^2)/16)-9)",\>add); plot2d("-sqrt(((9\*x^2)/16)-9)",\>add):


![images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-188.png](images/Gita%20Anggi%20Nurlita_22305141004_EMT4Geometry-188.png)
