...
\begin{eulercomment}
Dalam buku catatan ini, kami mendemonstrasikan plot statistik utama, tes, dan distribusi dalam Euler. Mari kita mulai dengan beberapa statistik deskriptif. Ini bukanlah sebuah pengantar statistik. Jadi, Anda mungkin memerlukan latar belakang untuk memahami detailnya.
\end{eulercomment}
...
Statistika deskriptif merupakan statistik yang mempelajari tata cara mengumpulkan, menyusun, menyajikan, dan menganalisis data yang berwujud angka agar dapat memberikan gambaran yang teratur, ringkas, dan jelas mengenai suatu gejala atau keadaan peristiwa. Analisis data yang tergolong statistik deskriptif terdiri dari distribusi frekuensi, ukuran pemusatan data (mean, median, modus), ukuran letak (kuartil, desil, persentil), ukuran dispersi (jangkauan atau rentang, varians, simpangan baku), dan teknis statistik lain yang bertujuan hanya untuk mengetahui gambaran atau kecenderungan data tanpa bermaksud melakukan generalisasi.\\
...
Median merupakah ruang lingkup kajian pada analisis statistika deskriptif yang termasuk dalam ukuran pemusatan data. Median adalah suatu nilai yang berada di tengah data setelah diurutkan dari data yang terkecil sampai yang terbesar atau sebaliknya.\\

Mean merupakan ruang lingkup kajian pada analisis statistika deskriptif yang termasuk dalam ukuran pemusatan data. Rata-rata hitung atau mean merupakan nilai yang menunjukkan pusat dari nilai data dan dapat mewakili keterpusatan data. Mean dapat diperoleh dengan membagi jumlah nilai-nilai data dengan jumlah individu(cacah data). Kita dapat mengetahui nilai rata-rata hitung (mean) pada data tunggal dengan menggunakan perintah EMT yaitu 'mean(x)' dan 'mean(x,f)'.\\
        
Modus adalah nilai yang sering muncul diantara sebaran data atau nilai yang memiliki frekuensi tertinggi dalam distribusi data.\\
...
Jangkauan adalah selisih antara nilai maksimum dengan nilai minimum dalam suatu kelompok atau susunan data.\\
        
Varians adalah ukuran keragaman yang melibatkan seluruh data, dengan menghitung rta-rata dari jumlah kuadrat nilai simpangan.\\

Standar deviasi adalah salah satu istilah dalam ilmu statistika yang merujuk pada suatu nilai yang digunakan dalam menentukan persebaran data pada suatu sampel dan melihat seberapa dekat data-data tersebut dengan nilai mean. Standar deviasi disebut juga dengan istilah simpangan baku.\\
...
\begin{eulercomment}
Asumsikan pengukuran berikut. Kita ingin menghitung nilai rata-rata dan deviasi standar yang diukur.
\end{eulercomment}
\begin{eulerprompt}
...
Kita dapat memplot Box-Plot untuk datanya. Dalam kasus kami, tidak ada outlier.
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-001.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-005.png}
\eulerheading{Tabel}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-012.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-013.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2}(\frac{t-m}{d})^2}\ dt.
\]
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-017.png}
\begin{eulercomment}
...
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-019.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-021.png}
\begin{eulercomment}
...
>  angle=30°,ccols=CP):
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-022.png}
\begin{eulercomment}
...
>shrinkwindow():
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-030.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-031.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-032.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-033.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-034.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-038.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-042.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-043.png}
\eulerheading{Tes}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-044.png}
\begin{eulerprompt}
>t=count(R,21);
\end{eulerprompt}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-045.png}
\begin{eulercomment}
Menghapus data.
\end{eulercomment}
\begin{eulerprompt}
...
\end{euleroutput}
    ...
    \begin{eulercomment}
        Namun pemberian nama untuk indeks tidak dimungkinkan dalam EMT. Untuk paket statistik, hal ini mungkin sering diperlukan untuk memudahkan
...
>statplot(u,f,"h"):
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-046.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-048.png}
\eulerheading{Daftar}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-049.png}
\begin{eulercomment}
...
\end{euleroutput}
\eulerheading{Masalah Statistika}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-050.png}
\begin{eulercomment}
\end{eulercomment}
\eulersubheading{}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulerprompt}
>plot2d(r,v,a=-5,b=110,c=0,d=25,bar=1,style="\(\backslash\)/"):
\end{eulerprompt}
\eulerimg{15}{images/22305141004_Gita Anggi Nurlita_EMT4Statistika-051.png}
\end{eulernotebook}
